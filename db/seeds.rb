...
Recipe.create(
  ...
  category: "Breakfast"
  decription: "Fresh asparagus, cherry tomatoes, and spinach join sharp, creamy feta cheese in this elegant breakfast offering."
...
"
  category: "Dinner"
  description: "This baked Italian chicken dinner is one of the easiest and most requested recipes. It's simple to make, and the ingredients are easy to find!"
